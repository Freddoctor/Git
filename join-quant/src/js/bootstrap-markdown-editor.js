...
! function(a) {
  ...
  var g = {
    init: function(g) {
      ...
      return q.setTheme("ace/theme/" + i.theme), q.getSession().setMode("ace/mode/" + (i.mode)), q.getSession().setUseWrapMode(!0), q.getSession().setUseSoftTabs(i.softTabs), q.getSession().on("change", function() {
