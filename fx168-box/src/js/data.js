...
import img1star2x from '../img/1star@2x.png';
import img2star2x from '../img/2star@2x.png';
import img3star2x from '../img/3star@2x.png';
import imgmg2x from '../img/mg@2x.png';
import imgrb2x from '../img/rb@2x.png';
import imgzg2x from '../img/zg@2x.png';

import imgyg2x from "../img/yg@2x.png";
import imgdg2x from "../img/dg@2x.png";
import imgfg2x from "../img/fg@2x.png";
import imgjnd2x from "../img/jnd@2x.png";
import imgadly2x from "../img/adly@2x.png";
import imgom2x from "../img/om@2x.png";
import imgxg2x from "../img/xg@2x.png";
import imghg2x from "../img/hg@2x.png";
import imgxjp2x from "../img/xjp@2x.png";
import imgrs2x from "../img/rs.png";
import imgxxl2x from "../img/xxl@2x.png";
import imgtw2x from "../img/tw@2x.png";
import imgydl2x from "../img/ydl@2x.png";
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      for (var i = 0; i < organizationArr.length; i++) {
        ...
        result += '<ul class="organizationWrap" cmsid="' + organizationArr[i].cmsid + '">' +
          '<li class="organization_title">' +
          '<img src="' + require("../img/shijian@2x.png") + '" />' +
