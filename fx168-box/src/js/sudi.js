                                ...
                                result +='<div data-zd='+dataArr[i].zhiding+' hxsdType='+dataArr[i].hxsdType+' isRed='+dataArr[i].isRed+' class="listWrap">'
                                                    ...
                                                    +'<ul class="ulWrap">'
                                                        ...
                                                        +'<div class="boder">'
                                                            ...
                                                            +'<li class="datatitle '+isHideMedia4+' '+style_red+'">'
                                                    ...
                                                    +'<div class="my-gallery '+isHideMedia+' '+isHideMedia2+' '+isHideMedia4+' '+isHideMedia5+'" data-pswp-uid="1">'
                                                        ...
                                                        // +'<figure class="fig1">'
                                                        //     +'<div>'
                                                        //         +'<a href='+dataArr[i].pics[0]+' data-size="750x500"><img class="sfImg"  src='+dataArr[i].pics[0]+'>'+'</a>'
                                                        //         +'<figcaption style="display:none;">'+"sdsdsdsdsds"+'</figcaption>'
                                                        //     +'</div>'
                                                        // +'</figure>'
                                                        ...
                                                        // +'<figure>'
                                                        //     +'<div>'
                                                        //         +'<a href='+dataArr[i].pics[1]+' data-size="750x500"><img class="sfImg"  src='+dataArr[i].pics[1]+'>'+'</a>'
                                                        //         +'<figcaption style="display:none;">'+"sdsdsdsdsds"+'</figcaption>'
                                                        //     +'</div>'
                                                        // +'</figure>'
                                                        ...
                                                        // +'<figure>'
                                                        //     +'<div>'
                                                        //         +'<a href='+dataArr[i].pics[2]+' data-size="750x500"><img class="sfImg"  src='+dataArr[i].pics[2]+'>'+'</a>'
                                                        //         +'<figcaption style="display:none;">'+"sdsdsdsdsds"+'</figcaption>'
                                                        //     +'</div>'
                                                        // +'</figure>'
                                                        // +'<figure>'
                                                        //     +'<div>'
                                                        //         +'<a href='+dataArr[i].pics[3]+' data-size="750x500"><img class="sfImg"  src='+dataArr[i].pics[2]+'>'+'</a>'
                                                        //         +'<figcaption style="display:none;">'+"sdsdsdsdsds"+'</figcaption>'
                                                        //     +'</div>'
                                                        // +'</figure>'
                                                        // +'<figure>'
                                                        //     +'<div>'
                                                        //         +'<a href='+dataArr[i].pics[4]+' data-size="750x500"><img class="sfImg"  src='+dataArr[i].pics[2]+'>'+'</a>'
                                                        //         +'<figcaption style="display:none;">'+"sdsdsdsdsds"+'</figcaption>'
                                                        //     +'</div>'
                                                        // +'</figure>'
...
function omyMp3(cc){
    ...
    $('.mp3Btn').on('ended', function() {
        ...
        $('.btn-audio').css({'background':'url(img/tingzhi@2x.png) no-repeat center bottom','background-size':'cover'});
    })
    ...
    if(newsId == $(cc).attr("data-id")  && newsId !=null){
        ...
        if (myaudio.paused) {
            ...
            obj.css({'background':'url(img/bofangz@2x.png) no-repeat center bottom','background-size':'cover'});
            myaudio.play();
            ...
            obj.css({'background':'url(img/tingzhi@2x.png) no-repeat center bottom','background-size':'cover'});
            myaudio.pause(); //暂停
...
function initSudiSocket() {
   // sudiUrl  "http://192.168.30.190:9093"
        socket = io.connect(sudiUrl, { 'reconnect': true });  
        socket.on('connect', function(data) {  
            socket.emit('msgH5', {"secret":"h5Socket","appType":"h5"}); 
        });  
                                            ...
                                            +'<ul class="ulWrap">'
                                                ...
                                                +'<div class="boder">'
                                                    ...
                                                    +'<li class="datatitle">'
                                                        ...
                                                        +'<span class="myTs">'+dataArr[i].title+'</spam>'
                                                    ...
                                                    +'</li>'
                                                +'</div>'
                                                +'<video class="video" poster="img/default@2x.png" src='+dataArr[i].vidio+' type="video/mp4" controls="controls">'+'</video>'
       ...
       for (var i = 0; i < $('figure').length; i++) {
        ...
        if ($('.listWrap2').eq(i).attr("data-star")==0) {
            ...
            // var substr2 = dataArr[i].publishTime.substring(11, 16);//时间
            // var liDate='<li class="liDate">'+substr2+'</li>';
