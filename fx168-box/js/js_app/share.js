$(function(){
    ...
    // window.brokerUserId ="1455657316374";
    // tabAnimate ();
    // 滚动定位tab
    scrollWindow ();    
    ajaxGetBasicData();
                               ...
                               for (var j = 0; j < childCommentsArr.length; j++) {
                                   childComments += '<ul>'
                                                       ...
                                                       +'<span class="targetnickM">'+"："+'</span>'
                                                           ...
                                                           +'<img class="icon" src="../img/img_app/picture@2x.png" />'
                                                  ...
                                                  +'<div class="plChild">'
                                                   ...
                                                   +'<div class="deleAndClick">'
                                                       ...
                                                       +'<span class="likePl" data-id='+perData.microblogId+'>'
                                                           +'<img src="../img/img_app/pinglun@2x.png" />'
...
function scrollWindow () {
    var headConHeight=$('.head_wrap').outerHeight()+$('.content').outerHeight();
    var scrollTop=0;
    $(window).scroll(function(){
        scrollTop=$(document).scrollTop();
         if (scrollTop>headConHeight) {
            ...
            // $('.con_wrap').css("margin-top","1.11rem");
        }
