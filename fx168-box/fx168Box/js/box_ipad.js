...
function getDataList(data) {
        ...
        res+='<ul class="list_data_list" isjt="'+true+'" zb_code="'+arr[i].zb_code+'" pubdatetime="'+arr[i].pub_datetime+'" tabIsTrue="'+true+'">'
                ...
                +'<li class="omtile_wrap">'
                    ...
                    +'<div class="omtile_wrap_divs mjt">'
                        +'<img class="jt" src="img/box_bigIpad/qiehuanzhankai@2x.png" />'
                    +'</div>'
                +'</li>'               
        +'</ul>'
        +'<div class="bar_chart">'
            +'<div class="country_wrap">'
                    +'<img src="img/box_bigIpad/biaoshi@1x.png" />'
    ...
    $('.list_data_list').click(function(e){
        ...
        if (isjt=="true") {
            ...
            $(this).find('.jt').attr("src",commonImgSrc+"/shouqi@2x.png")
                      
        }else{
            $(this).attr("isjt",true)
            $(this).find('.jt').attr("src",commonImgSrc+"/qiehuanzhankai@2x.png")
        }
        if(chartsWrap.html()==""){
                    ...
                    result+='<ul class="transactionList_wrap">'
                                ...
                                +'<li class="transactionList_right">'
                                    +'<div class="flex_between">'
                                        ...
                                        +'<span>'
                                            +'<img src="img/box_bigIpad/hezitime@2x.png" />'
