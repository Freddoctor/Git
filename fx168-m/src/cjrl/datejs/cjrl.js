$(document).ready(function(){
  ...
  console.log(localStorage.tabUrlIndex);
  $('.lia').click(function(){
...
// 刷新即加载财经列表
        $.ajax({
            url: "https://app5.fx168api.com/economic/getCalendarIndicator.json",
               dataType: "jsonp",
               type: "GET",
               data:{
                  strDate:rlDate
               ...
               success:function(data){
                   ...
                   for (var i = 0; i < rlnyListArr.length; i++) {
                       ...
                       // var timestr=- -  ";
                       var ssssssaaa="";
                       // console.log(rlnyListArr[i].time);
                   ...
                   $('.rl_list').click(function(){
                      for (var i = 0; i < $('.rl_list').length; i++) {
                            ...
                            */ 
                            ...
                            localStorage.currency=currency[index];
                      }
                   })
            ...
            function getdatacjrl(data){
                ...
                for (var i = 0; i < rlnyListArr.length; i++) {
                    ...
                    var sssssssss=rlnyListArr[i].textValueList;
                     ...
                     console.log(golvalData2);
                     console.log(goltypeData2);
                     var yxjx=rlnyListArr[i].type;
                     // 国家
                     var country=rlnyListArr[i].countryEn;
                     var conname=rlnyListArr[i].countryName;
...
$('.tabList1').append(resList);
  ...
  function cjbind(rlDate){
    ...
    $.ajax({
        url: "https://app5.fx168api.com/economic/getFinancialEvent.json",
        dataType: "jsonp",
        type: "GET",
        data:{
            strDate:rlDate
...
// 假日预告
 function initjryg(rlDate){
            $.ajax({
               url: "https://app5.fx168api.com/economic/getHolidayNotice.json",
                dataType: "jsonp",
                type: "GET",
                data:{
                    strDate:rlDate
