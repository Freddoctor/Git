$(function(){
    $(".find_nav_list").css("left",sessionStorage.left_cjrl+"px");
    ...
    $(".find_nav_list li").on('click', function(){
        ...
        sessionStorage.left_cjrl=fnl_l;
        // console.log(sessionStorage.left);
