...
$(document).ready(function() {
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      var substrldlkarr1 = [];
      var substrldlkarr2 = [];
      zwgb = '<img class="zwgb" src="' + require("../cjrImg/nzhong@2x.png") + '"></img>' + '<span class="zwgb_span" style="color:#e45555">' + "暂未公布" + '</span>';
      $(".tabList1").html("");
      ...
      for (var i = 0; i < rlnyListArr.length; i++) {
        ...
        resList += '<a href="rlzbny.html" class="rl_list">' +
          ...
          '<img class="star1" src="' + require("../cjrImg/xing@2x.png") + '">' + '</img>' +
          '<img class="star2" src="' + require("../cjrImg/xing@2x.png") + '">' + '</img>' +
          '<img class="star3" src="' + require("../cjrImg/xing@2x.png") + '">' + '</img>' +
          '</p>' +
          '<p class="flag">' +
          '<img data-src=' + country + ' src="' + require("../cjrImg/zg@2x.png") + '">' + '</img>' +
          '</p>' +
      ...
      if (resList == "") {
        resList = '<div class="noHoliday">' +
          ...
          '<img src="' + require("../cjrImg/zwjr@2x.png") + '">' +
          '<div>' + "暂无财经事件" + '</div>'
      ...
      for (var i = 0; i < $('.yx').length; i++) {
        ...
        if ($('.flag img')[i].getAttribute("data-src") == "USA") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/mg@2x.png"))

        } else if ($('.flag img')[i].getAttribute("data-src") == "AUS") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/adly@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "UK") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/yg@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "CAN") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/jnd@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "NZ") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/xxl@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "JPN") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/rb@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "SWI") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/rs@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "EU") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/om@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "SIN") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/xjp@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "ITA") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/ydl@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "SK") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/hg@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "GER") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/dg@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "TW") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/tw@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "HK") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/xg@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "FRA") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/fg@2x.png"))
        } else if ($('.flag img')[i].getAttribute("data-src") == "CHN") {
          $('.flag img').eq(i).attr("src", "" + require("../cjrImg/zg@2x.png"))
        }

        // 星级

        if ($('.star')[i].getAttribute("data-star") == 1) {
          $('.star1').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
          $('.star2').eq(i).attr("src", "" + require("../cjrImg/xing@2x fb.png"));
          $('.star3').eq(i).attr("src", "" + require("../cjrImg/xing@2x fb.png"));
        } else if ($('.star')[i].getAttribute("data-star") == 2) {
          $('.star1').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
          $('.star2').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
          $('.star3').eq(i).attr("src", "" + require("../cjrImg/xing@2x fb.png"));
        } else {
          $('.star1').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
          $('.star2').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
          $('.star3').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
  ...
  $(".find_nav_list li").click(function() {
    ...
    function getdatacjrl(data) {
      ...
      if (resList == "") {
        resList = '<div class="noHoliday">' +
          '<div class="noHoliday1">' +
          '<img src="' + require("../cjrImg/calendar@2x.png") + '">' +
          '<div>' + "暂无日历指标" + '</div>' +
          '</div>' +
          '</div>'
      ...
      success: function(data) {
        ...
        for (var i = 0; i < cjsj.length; i++) {
          ...
          cjsjRes += '<ul>' +
            ...
            '<img class="cjsj_star1"  src="' + require("../cjrImg/xing@2x.png") + '">' + '</img>' +
            '<img class="cjsj_star2"  src="' + require("../cjrImg/xing@2x.png") + '">' + '</img>' +
            '<img class="cjsj_star3"  src="' + require("../cjrImg/xing@2x.png") + '">' + '</img>' +
            '</li>' +
        ...
        if (cjsjRes == "") {
          ...
          cjsjRes = '<div class="noHoliday">' +
            '<div class="noHoliday1">' +
            '<img src="' + require("../cjrImg/cjsj@2x.png") + '">' +
            '<div>' + "暂无财经事件" + '</div>'
        ...
        for (var i = 0; i < $('.cjsj_star').length; i++) {
          if ($('.cjsj_star')[i].getAttribute("odata_src") == 1) {
            $('.cjsj_star1').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
            $('.cjsj_star2').eq(i).attr("src", "" + require("../cjrImg/xing@2x fb.png"));
            $('.cjsj_star3').eq(i).attr("src", "" + require("../cjrImg/xing@2x fb.png"));
          } else if ($('.cjsj_star')[i].getAttribute("odata_src") == 2) {
            $('.cjsj_star1').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
            $('.cjsj_star2').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
            $('.cjsj_star3').eq(i).attr("src", "" + require("../cjrImg/xing@2x fb.png"));
          } else {
            $('.cjsj_star1').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
            $('.cjsj_star2').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
            $('.cjsj_star3').eq(i).attr("src", "" + require("../cjrImg/xing@2x.png"));
          }
        }
