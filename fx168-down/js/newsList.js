...
var maxId="",minId="",channelId=localStorage.tabUrlIndex;
    var maxId1=null;
    var minId1=null;
    var pageSize=20;
...
function ajaxGetData(data){    
            ...
            for (var i = 0; i < $(".oli").length; i++) {
                ...
                if (timeArray[i].image==null||timeArray[i].image==undefined||timeArray[i].image=='') {
                    timeArray[i].image='img/newPic@2x.png';
                }
...
for (var i = 0; i < 20; i++) {
   ...
   //str+="<a href='###' class='oli'></a>";
    img="<img class='newImg' src='img/newPic@2x.png'>";
    clickimg="<img class='clickimg' src='img/lll@2x.png'>";
...
function closeTopBanner () {
    $('.close').click(function(){
        $('.wrap').hide();
        $('.find_nav').css("top",0);
        $('.banner').css("top","0.68rem");
        $('#content').css("top","0.8rem");
        $('.flag_wrap').css("top","0.9rem");
        $('.moudle').css("height","0.88rem");
...
function openApp(){  
    ...
    if(ua.match(/MicroMessenger/i) == 'micromessenger'){  
        ...
        if (navigator.userAgent.match(/(iPhone|iPod|iPad);?/i)) {  
            ...
            window.location = "fx168://m.fx168.com/main?type=sy";  
