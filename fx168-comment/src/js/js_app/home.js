...
var zeroCom = require("./zero.plugin.js");
var mCustomScrollbar = require("./jquery.mCustomScrollbar.concat.min.js");
var lazyloadCom = require("./jquery.lazyload.min.js");
var swiperCom = require("../swiper.min.js");
        ...
        success: function(data) {
          ...
          if (listResArr == "" || listResArr == null || listResArr.length == 0) {
            ...
            var noDataImg = '<div class="noImgWrap">'
              ...
              +
              '<img src="'+ require("../../img/img_app/no_jjs@2x.png")+'" />' +
              '<p>' + "暂无相关经纪商" + '<p/>'
...
function selectBox() {
  ...
  $('.selectBox_bottom').click(function() {
    ...
    if (thisState == "false") {
      ...
      $(".dealer .dealer_sq_img").attr("src", ""+ require("../../img/img_app/zhankai@2x.png")+"");
  ...
  $(".dealer").click(function() {
    ...
    if (thisState == "true") {
      ...
      $(".dealer .dealer_sq_img").attr("src", ""+ require("../../img/img_app/shouqiblue.png")+"");
    ...
    if (data.length > 0) {
      for (var i = 0; i < data.length; i++) {
        str += '<ul style="border-bottom: 0.01rem solid #DDDDDD;" class="commission_wrap">\
				...
				<div class="tile_img"><img class="lazy" data-original="' + data[i].logo + '" src="'+ require("../../img/img_app/liebiao@2x.png")+'">\
				</div>\
      ...
      for (var i = 0; i < data.length; i++) {
        str += '<ul class="commission_wrap">\
          <li class="commission_inner" data-three="true" data-userid="' + data[i].userId + '">\
            <div class="tile_img">\
              <img class="lazy" data-original="' + data[i].logo + '" src="'+ require("../../img/img_app/liebiao@2x.png")+'">\
            </div>\
            <div class="commission_middle">\
              <ul>\
                <div class="spread_wrap spread">\
    ...
    for (var i = 0; i < list.length; i++) {
      str += '<ul class="commission_wrap">\
          ...
          data-title="' + list[i].name + '" data-logo="' + list[i].logo + '" data-link="' + list[i].activityLink + '" >\
						<div class="tile_img">\
						<img class="lazy" data-original="' + list[i].logo + '" src="'+ require("../../img/img_app/liebiao@2x.png")+'"> </div>\
...
function getScreenData(objScreen) {
  $('.sx').css("color", "#3285ea");
  $('.screen img').attr("src", ""+ require("../../img/img_app/shaixuan1@2x.png")+"");
  $('.dropload-down').show();
